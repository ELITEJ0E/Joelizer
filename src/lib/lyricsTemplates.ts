...
export const LYRIC_VIDEO_TEMPLATES: Record<LyricTemplateId, LyricVideoTemplate> = {
  ...
  square: {
    ...
    typography: { fontFamily: 'Outfit', fontWeight: '800', fontSizeScale: 1.0, textColor: '#ffffff', activeWordColor: '#38bdf8', inactiveWordColor: 'rgba(255, 255, 255, 0.65)', glowColor: '#0284c7', shadowColor: 'rgba(0,0,0,0.8)', showContainerPill: true, pillBgColor: 'rgba(0, 0, 0, 0.65)' },
  ...
  circle: {
    ...
    typography: { fontFamily: 'Outfit', fontWeight: '700', fontSizeScale: 1.05, textColor: '#fce7f3', activeWordColor: '#f9a8d4', inactiveWordColor: 'rgba(252, 231, 243, 0.65)', glowColor: '#ec4899', shadowColor: 'rgba(0,0,0,0.7)', showContainerPill: true, pillBgColor: 'rgba(131, 24, 67, 0.4)' },
  ...
  'vinyl-needle': {
    ...
    typography: { fontFamily: 'Outfit', fontWeight: '900', fontSizeScale: 1.15, textColor: '#ffffff', activeWordColor: '#fde047', inactiveWordColor: 'rgba(255, 255, 255, 0.85)', glowColor: '#ca8a04', shadowColor: 'rgba(0,0,0,0.95)', showContainerPill: true, pillBgColor: 'rgba(0, 0, 0, 0.8)' },
    animations: { lineAnimation: 'slide-up', wordAnimation: 'karaoke', intensity: 1.0 },
  ...
  'cd-needle': {
    ...
    typography: { fontFamily: 'Outfit', fontWeight: '800', fontSizeScale: 1.1, textColor: '#ffffff', activeWordColor: '#22d3ee', inactiveWordColor: 'rgba(255, 255, 255, 0.5)', glowColor: '#0891b2', shadowColor: 'rgba(6, 182, 212, 0.9)', showContainerPill: true, pillBgColor: 'rgba(8, 51, 68, 0.75)' },
